...
const Highlights = () => {
  const [products] = useState([
    { id: 1, name: "Apple AirPods Pro", image: productimg1, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
    { id: 2, name: "Capa Apple Magic Keyboard", image: productimg2, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
    { id: 3, name: "Apple iPad Pro", image: productimg3, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
    { id: 4, name: "iPhone 13", image: productimg4, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
    { id: 5, name: "Capa Apple Smart iPad Pro", image: productimg5, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
    { id: 6, name: "WATCH Ultra", image: productimg6, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
    { id: 7, name: "iPad Pro", image: productimg7, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
    { id: 8, name: "Macbook Air", image: productimg8, price: '169€', description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.", inStock:'Em Stock', eta:'Entrega Prevista a partir de 17 JAN' },
  ]);
  return (
      <>
